...
func (c *CassandraBenchmarker) UpdateRecords(keyType string, numOps, connections int, connString string, execMode workload.ExecutionMode, consistency, idFile string) (*workload.WorkloadResult, error) {
